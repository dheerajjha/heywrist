    ...
    faqs: [
      {
        ...
        a: "Yes. Sona uses a secure enterprise cloud AI service to generate AI responses. Your message text \u2014 plus any image you attach, recent context from the same conversation, the persona\u2019s system prompt, and any facts you saved as Memory \u2014 is sent to our cloud AI provider over HTTPS so the AI can respond. We do not attach your name, email, or device identifier (we don\u2019t have any of those). Under our provider\u2019s enterprise terms, your prompts are not used to train AI models, and retention is limited to 30 days for abuse monitoring. See the Privacy Policy for the full breakdown.",
      },
      {
    ...
    faqs: [
      {
        ...
        a: "Sona requires an internet connection because AI responses are generated by a cloud AI service. Check Wi-Fi or cellular and tap Retry on the failed message. If the issue persists, force-quit and reopen the app. If it still fails, email founder@heywrist.com with the approximate time of the failure so we can check upstream status on our side.",
      },
      {
