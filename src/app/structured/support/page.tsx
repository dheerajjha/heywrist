  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-16">
      ...
      <section className="rounded-2xl border border-white/10 bg-slate-900/50 p-8 text-center">
        ...
        <a href="mailto:founder@heywrist.com" className="inline-flex items-center gap-2 rounded-full bg-teal-600 px-6 py-2.5 text-sm font-medium text-white hover:bg-teal-500 transition-colors">
      ...
      <footer className="mt-16 pt-8 border-t border-white/10 text-sm text-slate-500">
        ...
        <p className="mt-1">Contact: <a href="mailto:founder@heywrist.com" className="text-teal-400 hover:text-teal-300">founder@heywrist.com</a></p>
      </footer>
    </main>
  );
}
